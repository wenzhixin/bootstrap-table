(function (global, factory) {
  ...
  try {
    var rawVersion = _jquery2.default.fn.dropdown.Constructor.VERSION;
  ...
  var Utils = {
    ...
    getScrollBarWidth: function getScrollBarWidth() {
      if (this.cachedWidth === null) {
        var $inner = (0, _jquery2.default)('<div/>').addClass('fixed-table-scroll-inner');
        var $outer = (0, _jquery2.default)('<div/>').addClass('fixed-table-scroll-outer');

        $outer.append($inner);
        (0, _jquery2.default)('body').append($outer);
  ...
  var DEFAULTS = {
    ...
    customSearch: _jquery2.default.noop,
    customSort: _jquery2.default.noop,
  ...
  _jquery2.default.extend(DEFAULTS, LOCALES['en-US']);
    ...
    _createClass(BootstrapTable, [{
      ...
      value: function initLocale() {
        if (this.options.locale) {
          var locales = _jquery2.default.fn.bootstrapTable.locales;
          ...
          if (locales[this.options.locale]) {
            // locale as requested
            _jquery2.default.extend(this.options, locales[this.options.locale]);
          } else if (_jquery2.default.fn.bootstrapTable.locales[parts.join('-')]) {
            // locale with sep set to - (in case original was specified with _)
            _jquery2.default.extend(this.options, locales[parts.join('-')]);
          } else if (_jquery2.default.fn.bootstrapTable.locales[parts[0]]) {
            // short locale language code (i.e. 'en')
            _jquery2.default.extend(this.options, locales[parts[0]]);
          }
        }
      }
    }, {
      ...
      value: function initContainer() {
        ...
        if (this.options.buttonsToolbar) {
          this.$toolbar = (0, _jquery2.default)('body').find(this.options.buttonsToolbar);
        } else {
      ...
      value: function initTable() {
        ...
        if (!this.$header.length) {
          this.$header = (0, _jquery2.default)('<thead class="' + this.options.theadClasses + '"></thead>').appendTo(this.$el);
        }
        this.$header.find('tr').each(function (i, el) {
          var column = [];

          (0, _jquery2.default)(el).find('th').each(function (i, el) {
            // #2014: getFieldIndex and elsewhere assume this is string, causes issues if not
            if (typeof (0, _jquery2.default)(el).data('field') !== 'undefined') {
              (0, _jquery2.default)(el).data('field', '' + (0, _jquery2.default)(el).data('field'));
            }
            column.push(_jquery2.default.extend({}, {
              title: (0, _jquery2.default)(el).html(),
              'class': (0, _jquery2.default)(el).attr('class'),
              titleTooltip: (0, _jquery2.default)(el).attr('title'),
              rowspan: (0, _jquery2.default)(el).attr('rowspan') ? +(0, _jquery2.default)(el).attr('rowspan') : undefined,
              colspan: (0, _jquery2.default)(el).attr('colspan') ? +(0, _jquery2.default)(el).attr('colspan') : undefined
            }, (0, _jquery2.default)(el).data()));
          });
          columns.push(column);
        });
        ...
        this.options.columns = _jquery2.default.extend(true, [], columns, this.options.columns);
        this.columns = [];
        ...
        this.options.columns.forEach(function (columns, i) {
          columns.forEach(function (_column, j) {
            var column = _jquery2.default.extend({}, BootstrapTable.COLUMN_DEFAULTS, _column);
        ...
        this.$el.find('>tbody>tr').each(function (y, el) {
          ...
          row._id = (0, _jquery2.default)(el).attr('id');
          row._class = (0, _jquery2.default)(el).attr('class');
          row._data = Utils.getRealDataAttr((0, _jquery2.default)(el).data());

          (0, _jquery2.default)(el).find('>td').each(function (_x, el) {
            var cspan = +(0, _jquery2.default)(el).attr('colspan') || 1;
            var rspan = +(0, _jquery2.default)(el).attr('rowspan') || 1;
            var x = _x;
            ...
            row[field] = (0, _jquery2.default)(el).html();
            // save td's id, class and data-* attributes
            row['_' + field + '_id'] = (0, _jquery2.default)(el).attr('id');
            row['_' + field + '_class'] = (0, _jquery2.default)(el).attr('class');
            row['_' + field + '_rowspan'] = (0, _jquery2.default)(el).attr('rowspan');
            row['_' + field + '_colspan'] = (0, _jquery2.default)(el).attr('colspan');
            row['_' + field + '_title'] = (0, _jquery2.default)(el).attr('title');
            row['_' + field + '_data'] = Utils.getRealDataAttr((0, _jquery2.default)(el).data());
          });
          data.push(row);
        });
      ...
      value: function initHeader() {
        ...
        this.$header.find('th[data-field]').each(function (i, el) {
          (0, _jquery2.default)(el).data(visibleColumns[(0, _jquery2.default)(el).data('field')]);
        });
        ...
        this.$header.children().children().off('keypress').on('keypress', function (e) {
          if (_this2.options.sortable && (0, _jquery2.default)(e.currentTarget).data().sortable) {
        ...
        (0, _jquery2.default)(window).off('resize.bootstrap-table');
        if (!this.options.showHeader || this.options.cardView) {
          ...
          this.getCaret();
          (0, _jquery2.default)(window).on('resize.bootstrap-table', _jquery2.default.proxy(this.resetWidth, this));
        }
        ...
        this.$selectAll.off('click').on('click', function (_ref4) {
          ...
          var checked = (0, _jquery2.default)(currentTarget).prop('checked');
      ...
      value: function initSort() {
        ...
        if (this.options.customSort !== _jquery2.default.noop) {
        ...
        if (index !== -1) {
          ...
          this.data.sort(function (a, b) {
            ...
            if (_jquery2.default.isNumeric(aa) && _jquery2.default.isNumeric(bb)) {
      ...
      value: function onSort(_ref5) {
        ...
        var $this = type === 'keypress' ? (0, _jquery2.default)(currentTarget) : (0, _jquery2.default)(currentTarget).parent();
      ...
      value: function initToolbar() {
        ...
        if (this.$toolbar.find('.bs-bars').children().length) {
          (0, _jquery2.default)('body').append((0, _jquery2.default)(this.options.toolbar));
        }
        this.$toolbar.html('');

        if (typeof this.options.toolbar === 'string' || _typeof(this.options.toolbar) === 'object') {
          (0, _jquery2.default)(Utils.sprintf('<div class="bs-bars %s-%s"></div>', bootstrap.classes.pull, this.options.toolbarAlign)).appendTo(this.$toolbar).append((0, _jquery2.default)(this.options.toolbar));
        }
        ...
        if (this.options.showFullscreen) {
          this.$toolbar.find('button[name="fullscreen"]').off('click').on('click', _jquery2.default.proxy(this.toggleFullscreen, this));
        }
        ...
        if (this.options.showPaginationSwitch) {
          this.$toolbar.find('button[name="paginationSwitch"]').off('click').on('click', _jquery2.default.proxy(this.togglePagination, this));
        }

        if (this.options.showRefresh) {
          this.$toolbar.find('button[name="refresh"]').off('click').on('click', _jquery2.default.proxy(this.refresh, this));
        }
        ...
        if (this.options.showColumns) {
          ...
          $keepOpen.find('input').off('click').on('click', function (_ref6) {
            ...
            var $this = (0, _jquery2.default)(currentTarget);
      ...
      value: function onSearch(_ref7) {
        ...
        var text = _jquery2.default.trim((0, _jquery2.default)(currentTarget).val());

        // trim search input
        if (this.options.trimOnSearch && (0, _jquery2.default)(currentTarget).val() !== text) {
          (0, _jquery2.default)(currentTarget).val(text);
        }
      ...
      value: function initSearch() {
        ...
        if (this.options.sidePagination !== 'server') {
          if (this.options.customSearch !== _jquery2.default.noop) {
          ...
          var f = _jquery2.default.isEmptyObject(this.filterColumns) ? null : this.filterColumns;
          ...
          this.data = s ? this.data.filter(function (item, i) {
            for (var j = 0; j < _this5.header.fields.length; j++) {
              ...
              var key = _jquery2.default.isNumeric(_this5.header.fields[j]) ? parseInt(_this5.header.fields[j], 10) : _this5.header.fields[j];
      ...
      value: function initPagination() {
        ...
        if (!this.options.onlyInfoPagination) {
          ...
          $pageList.off('click').on('click', _jquery2.default.proxy(this.onPageListChange, this));
          $pre.off('click').on('click', _jquery2.default.proxy(this.onPagePre, this));
          $next.off('click').on('click', _jquery2.default.proxy(this.onPageNext, this));
          $number.off('click').on('click', _jquery2.default.proxy(this.onPageNumber, this));
        }
      }
    }, {
      ...
      value: function updatePagination(event) {
        ...
        if (event && (0, _jquery2.default)(event.currentTarget).hasClass('disabled')) {
          return;
        }
      ...
      value: function onPageNumber(event) {
        event.preventDefault();
        if (this.options.pageNumber === +(0, _jquery2.default)(event.currentTarget).text()) {
          return;
        }
        this.options.pageNumber = +(0, _jquery2.default)(event.currentTarget).text();
        this.updatePagination(event);
        return false;
      }
    }, {
      ...
      value: function initRow(item, i, data, parentDom) {
        ...
        if (item._data && !_jquery2.default.isEmptyObject(item._data)) {
        ...
        this.header.fields.forEach(function (field, j) {
          ...
          if (item['_' + field + '_data'] && !_jquery2.default.isEmptyObject(item['_' + field + '_data'])) {
      ...
      value: function initBody(fixedScroll) {
        ...
        if (!this.$body.length) {
          this.$body = (0, _jquery2.default)('<tbody></tbody>').appendTo(this.$el);
        }
        ...
        var trFragments = (0, _jquery2.default)(document.createDocumentFragment());
        var hasTr = false;
        ...
        this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (_ref18) {
          ...
          var $td = (0, _jquery2.default)(currentTarget);
          var $tr = $td.parent();
        ...
        this.$body.find('> tr[data-index] > td > .detail-icon').off('click').on('click', function (e) {
          ...
          var $this = (0, _jquery2.default)(e.currentTarget); // Fix #980 Detail view, when searching, returns wrong row
      ...
      value: function initServer(silent, query, url) {
        ...
        _jquery2.default.extend(data, query || {});
        ...
        var request = _jquery2.default.extend({}, Utils.calculateObjectValue(null, this.options.ajaxOptions), {
        ...
        if (this.options.ajax) {
          ...
          this._xhr = _jquery2.default.ajax(request);
        }
      }
    }, {
      key: 'initSearchText',
      ...
      value: function getCaret() {
        ...
        this.$header.find('th').each(function (i, th) {
          (0, _jquery2.default)(th).find('.sortable').removeClass('desc asc').addClass((0, _jquery2.default)(th).data('field') === _this10.options.sortName ? _this10.options.sortOrder : 'both');
        });
      }
    }, {
      key: 'updateSelected',
      value: function updateSelected() {
        ...
        this.$selectItem.each(function (i, el) {
          (0, _jquery2.default)(el).closest('tr')[(0, _jquery2.default)(el).prop('checked') ? 'addClass' : 'removeClass']('selected');
        });
      }
    }, {
      key: 'updateRows',
      value: function updateRows() {
        ...
        this.$selectItem.each(function (i, el) {
          _this11.data[(0, _jquery2.default)(el).data('index')][_this11.header.stateField] = (0, _jquery2.default)(el).prop('checked');
        });
      }
    }, {
      key: 'resetRows',
      ...
      value: function trigger(_name) {
        ...
        this.$el.trigger(_jquery2.default.Event(name), args);

        this.options.onAll(name, args);
        this.$el.trigger(_jquery2.default.Event('all.bs.table'), [name, args]);
      }
    }, {
      key: 'resetHeader',
      value: function resetHeader() {
        ...
        this.timeoutId_ = setTimeout(_jquery2.default.proxy(this.fitHeader, this), this.$el.is(':hidden') ? 100 : 0);
      }
    }, {
      key: 'fitHeader',
      value: function fitHeader() {
        ...
        if (this.$el.is(':hidden')) {
          this.timeoutId_ = setTimeout(_jquery2.default.proxy(this.fitHeader, this), 100);
          return;
        }
        ...
        var focused = (0, _jquery2.default)(':focus');
        if (focused.length > 0) {
        ...
        var focusedTemp = (0, _jquery2.default)('.focus-temp:visible:eq(0)');
        ...
        this.$header.find('th[data-field]').each(function (i, el) {
          _this12.$header_.find(Utils.sprintf('th[data-field="%s"]', (0, _jquery2.default)(el).data('field'))).data((0, _jquery2.default)(el).data());
        });
        ...
        this.$body.find('>tr:first-child:not(.no-records-found) > *').each(function (i, el) {
          ...
          if ($th.length > 1) {
            $th = (0, _jquery2.default)($ths[$this[0].cellIndex]);
          }
      ...
      value: function resetFooter() {
        ...
        this.timeoutFooter_ = setTimeout(_jquery2.default.proxy(this.fitFooter, this), this.$el.is(':hidden') ? 100 : 0);
      }
    }, {
      key: 'fitFooter',
      value: function fitFooter() {
        clearTimeout(this.timeoutFooter_);
        if (this.$el.is(':hidden')) {
          this.timeoutFooter_ = setTimeout(_jquery2.default.proxy(this.fitFooter, this), 100);
          return;
        }
      ...
      value: function horizontalScroll() {
        ...
        this.$tableBody.off('scroll').on('scroll', function (_ref23) {
          ...
          if (_this13.options.showHeader && _this13.options.height) {
            _this13.$tableHeader.scrollLeft((0, _jquery2.default)(currentTarget).scrollLeft());
          }

          if (_this13.options.showFooter && !_this13.options.cardView) {
            _this13.$tableFooter.scrollLeft((0, _jquery2.default)(currentTarget).scrollLeft());
          }
        });
      }
    }, {
      ...
      value: function getData(useCurrentPage) {
        ...
        if (this.searchText || this.options.sortName || !_jquery2.default.isEmptyObject(this.filterColumns) || !_jquery2.default.isEmptyObject(this.filterColumnsPartial)) {
          data = this.data;
        }
      ...
      value: function updateByUniqueId(params) {
        ...
        try {
          for (var _iterator19 = allParams[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
            ...
            _jquery2.default.extend(this.options.data[rowId], _params.row);
          }
        } catch (err) {
      ...
      value: function refreshColumnTitle(params) {
        ...
        if (this.columns[this.fieldsColumnsIndex[params.field]].visible) {
          ...
          header.find('th[data-field]').each(function (i, el) {
            if ((0, _jquery2.default)(el).data('field') === params.field) {
              (0, _jquery2.default)((0, _jquery2.default)(el).find('.th-inner')[0]).text(params.title);
              return false;
            }
          });
        }
      ...
      value: function updateRow(params) {
        ...
        try {
          for (var _iterator20 = allParams[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
            ...
            _jquery2.default.extend(this.options.data[_params2.index], _params2.row);
          }
        } catch (err) {
      ...
      value: function getOptions() {
        ...
        var options = _jquery2.default.extend({}, this.options);
        delete options.data;
        return _jquery2.default.extend(true, {}, options);
      }
    }, {
      key: 'getSelections',
      ...
      value: function checkInvert() {
        ...
        $items.each(function (i, el) {
          (0, _jquery2.default)(el).prop('checked', !(0, _jquery2.default)(el).prop('checked'));
        });
        this.updateRows();
        this.updateSelected();
      ...
      value: function destroy() {
        ...
        (0, _jquery2.default)(this.options.toolbar).insertBefore(this.$el);
      ...
      value: function filterBy(columns) {
        this.filterColumns = _jquery2.default.isEmptyObject(columns) ? {} : columns;
        this.options.pageNumber = 1;
        this.initSearch();
        this.updatePagination();
      }
      ...
      value: function expandAllRows(isSubTable) {
        ...
        if (isSubTable) {
          ...
          for (var i = 0; i < trs.length; i++) {
            this.expandRow_(true, (0, _jquery2.default)(trs[i]).data('index'));
          }
        }
      }
    }, {
      ...
      value: function collapseAllRows(isSubTable) {
        if (isSubTable) {
          ...
          var trs = this.$body.children();
          for (var i = 0; i < trs.length; i++) {
            this.expandRow_(false, (0, _jquery2.default)(trs[i]).data('index'));
          }
        }
      }
    }, {
  ...
  _jquery2.default.BootstrapTable = BootstrapTable;
  _jquery2.default.fn.bootstrapTable = function (option) {
    ...
    this.each(function (i, el) {
      var data = (0, _jquery2.default)(el).data('bootstrap.table');
      var options = _jquery2.default.extend({}, BootstrapTable.DEFAULTS, (0, _jquery2.default)(el).data(), (typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object' && option);
      ...
      if (typeof option === 'string') {
        ...
        if (option === 'destroy') {
          (0, _jquery2.default)(el).removeData('bootstrap.table');
        }
      }

      if (!data) {
        (0, _jquery2.default)(el).data('bootstrap.table', data = new _jquery2.default.BootstrapTable(el, options));
      }
    });
  ...
  _jquery2.default.fn.bootstrapTable.Constructor = BootstrapTable;
  _jquery2.default.fn.bootstrapTable.defaults = BootstrapTable.DEFAULTS;
  _jquery2.default.fn.bootstrapTable.columnDefaults = BootstrapTable.COLUMN_DEFAULTS;
  _jquery2.default.fn.bootstrapTable.locales = BootstrapTable.LOCALES;
  _jquery2.default.fn.bootstrapTable.methods = allowedMethods;
  _jquery2.default.fn.bootstrapTable.utils = Utils;

  // BOOTSTRAP TABLE INIT
  // =======================

  (0, _jquery2.default)(function () {
    (0, _jquery2.default)('[data-toggle="table"]').bootstrapTable();
  });
});