    ...
    _createClass(_class, [{
      ...
      value: function initTable() {
        ...
        _jquery2.default.each(this.columns, function (i, column) {
          ...
          _jquery2.default.each(_this2.options, processDataOptions);
          ...
          column.formatter = function (value, row, index) {
            ...
            _jquery2.default.each(column, processDataOptions);

            _jquery2.default.each(editableOptions, function (key, value) {
