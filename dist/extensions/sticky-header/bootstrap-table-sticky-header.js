(function (global, factory) {
  ...
  */
  ...
  var Utils = $$2.fn.bootstrapTable.utils;
  ...
  $$2.BootstrapTable = /*#__PURE__*/function (_$$BootstrapTable) {
    ...
    return _createClass(_class, [{
      ...
      value: function initHeader() {
        ...
        $$2(window).off(resizeEvent).on(resizeEvent, function () {
          return _this.renderStickyHeader();
        });
        $$2(window).off(scrollEvent).on(scrollEvent, function () {
          return _this.renderStickyHeader();
        });
      ...
      value: function resetView() {
        ...
        $$2('.bootstrap-table.fullscreen').off('scroll').on('scroll', function () {
      ...
      value: function getCaret() {
        ...
        if (this.$stickyHeader) {
          ...
          this.$header.find('th').each(function (i, th) {
            $ths.eq(i).find('.sortable').attr('class', $$2(th).find('.sortable').attr('class'));
          });
        }
      }
    }, {
      ...
      value: function renderStickyHeader() {
        ...
        if (this.options.filterControl) {
          $$2(this.$stickyHeader).off('keyup change mouseup').on('keyup change mouse', function (e) {
        ...
        if (top > start && top <= end) {
          ...
          this.$stickyHeader.find('tr').each(function (indexRows, rows) {
            $$2(rows).find('th').each(function (index, el) {
              $$2(el).css('min-width', _this4.$header.find("tr:eq(".concat(indexRows, ")")).find("th:eq(".concat(index, ")")).css('width'));
            });
          });
