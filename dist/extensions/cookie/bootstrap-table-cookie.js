(function (global, factory) {
        ...
        setTimeout(function () {
            ...
            if (!bootstrapTable.options.filterControlValuesLoaded && parsedCookieFilters) {
                ...
                var cachedFilters = {},
                    ...
                    (0, _jquery2.default)(filteredCookies).each(function (i, cookie) {
                        if (cookie.text !== '') {
                            (0, _jquery2.default)(element).val(cookie.text);
                ...
                header.find(searchControls).each(function () {
                    var field = (0, _jquery2.default)(this).closest('[data-field]').data('field'),
                        filteredCookies = _jquery2.default.grep(parsedCookieFilters, function (cookie) {
    ...
    _jquery2.default.fn.bootstrapTable.methods.push('getCookies');
    _jquery2.default.fn.bootstrapTable.methods.push('deleteCookie');

    _jquery2.default.extend(_jquery2.default.fn.bootstrapTable.utils, {
        setCookie: setCookie,
        getCookie: getCookie
    });
    ...
    BootstrapTable.prototype.initCookie = function () {
        ...
        if (columnsCookie) {
            _jquery2.default.each(this.columns, function (i, column) {
                column.visible = _jquery2.default.inArray(column.field, columnsCookie) !== -1;
            });
        }
    };
    ...
    BootstrapTable.prototype.onSearch = function () {
        ...
        if ((0, _jquery2.default)(target[0].currentTarget).parent().hasClass('search')) {
    ...
    BootstrapTable.prototype.getCookies = function () {
        var bootstrapTable = this;
        var cookies = {};
        _jquery2.default.each(cookieIds, function (key, value) {
