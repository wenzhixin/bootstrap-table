(function (global, factory) {
    ...
    var getParentRowId = function getParentRowId(that, id) {
        ...
        for (var i = 0; i < parentRows.length; i++) {
            if (i === id) {
                return (0, _jquery2.default)(parentRows[i]).attr('data-tt-id');
            }
        }
    ...
    var sumData = function sumData(that, data) {
        var sumRow = {};
        _jquery2.default.each(data, function (i, row) {
            if (!row.IsParent) {
                for (var prop in row) {
    ...
    var groupBy = function groupBy(array, f) {
        var groups = {};
        _jquery2.default.each(array, function (i, o) {
    ...
    var makeGrouped = function makeGrouped(that, data) {
        ...
        for (var i = 0; i < result.length; i++) {
            ...
            if (that.options.groupBySumGroup) {
                ...
                if (!_jquery2.default.isEmptyObject(sumRow)) {
    ...
    _jquery2.default.fn.bootstrapTable.methods.push('collapseAll', 'expandAll', 'refreshGroupByField');
    ...
    BootstrapTable.prototype.init = function () {
        ...
        if (!this.options.sortName) {
            if (this.options.groupBy && this.options.groupByField.length > 0) {
                ...
                if (!Object.keys) {
                    _jquery2.default.fn.bootstrapTable.utils.objectKeys();
                }
    ...
    BootstrapTable.prototype.refreshGroupByField = function (groupByFields) {
        if (!_jquery2.default.fn.bootstrapTable.utils.compareObjects(this.options.groupByField, groupByFields)) {
