(function (global, factory) {
    ...
    BootstrapTable.prototype.makeRowsReorderable = function () {
        var that = this;
        try {
            (0, _jquery2.default)(this.$el).dragtable('destroy');
        } catch (e) {}
        (0, _jquery2.default)(this.$el).dragtable({
            ...
            beforeStop: function beforeStop() {
                ...
                that.$header.find('th').each(function (i) {
                    ths.push((0, _jquery2.default)(this).data('field'));
                    formatters.push((0, _jquery2.default)(this).data('formatter'));
                });

                //Exist columns not shown
                if (ths.length < that.columns.length) {
                    columnsHidden = _jquery2.default.grep(that.columns, function (column) {
