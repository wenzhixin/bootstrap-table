(function (global, factory) {
  ...
  var navigator$1 = globalThis$b.navigator;
    ...
    return _createClass(_class, [{
      ...
      value: function initFixedColumnsEvents() {
        ...
        var toggleHover = function toggleHover(e, toggle) {
          var tr = "tr[data-index=\"".concat($$5(e.currentTarget).data('index'), "\"]");
          ...
          $trs.css('background-color', toggle ? $$5(e.currentTarget).css('background-color') : '');
        };
        ...
        if (this.options.filterControl) {
          $$5(this.$fixedColumns).off('keyup change').on('keyup change', function (e) {
