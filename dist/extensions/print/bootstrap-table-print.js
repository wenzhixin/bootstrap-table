(function (global, factory) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showPrint) {
            ...
            if (!$print.length) {
                $print = (0, _jquery2.default)(['<button class="bs-print btn btn-default' + sprintf(' btn-%s"', this.options.iconSize) + ' name="print" title="print" type="button">', sprintf('<i class="%s %s"></i> ', this.options.iconsPrefix, this.options.icons.print), '</button>'].join('')).appendTo($btnGroup);
