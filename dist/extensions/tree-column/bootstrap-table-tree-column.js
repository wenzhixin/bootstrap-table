(function (global, factory) {
    ...
    _jquery2.default.extend(_jquery2.default.fn.bootstrapTable.defaults, {
        ...
        onTreeFormatter: function onTreeFormatter(row) {
            ...
            var that = this;
            var nodes = [];
            _jquery2.default.each(data, function (i, item) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        if (treeShowField) {
            _jquery2.default.each(this.header.fields, function (i, field) {
    ...
    var initNode = function initNode(item, idx, data, parentDom) {
        ...
        for (var i = 0; i <= len; i++) {
            ...
            initNode.apply(that, [node, _jquery2.default.inArray(node, data), data, parentDom]);
        }
    };
