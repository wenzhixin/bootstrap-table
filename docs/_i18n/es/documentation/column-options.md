...
Las propiedades de la columna est谩n definidas en `jQuery.fn.bootstrapTable.columnDefaults`.
...
<table class="table"
    ...
    <tr>
        ...
        <td>String</td>
        <td>undefined</td>
        <td>Indica c贸mo se alinea la columna. Se puede usar "left', 'right', 'center'.</td>
    </tr>
    <tr>
        <td>halign</td>
        <td>data-halign</td>
        <td>String</td>
        <td>undefined</td>
        <td>Indica c贸mo se alinea el encabezado de la tabla. Se puede usar 'left', 'right', 'center'.</td>
    </tr>
	<tr>
        <td>falign</td>
        <td>data-falign</td>
        <td>String</td>
        <td>undefined</td>
        <td>Indica c贸mo se alinea el footer. Se puede usar 'left', 'right', 'center'.</td>
    </tr>
    <tr>
        <td>valign</td>
        <td>data-valign</td>
        <td>String</td>
        <td>undefined</td>
        <td>Indica c贸mo se alinea el contenido de la celda. Se puede usar 'top', 'middle', 'bottom'.</td>
    </tr>
    <tr>
        <td>width</td>
        <td>data-width</td>
        <td>Number</td>
        <td>undefined</td>
        <td>El ancho de la columna. Si no es definido, el ancho se adaptar谩 al contenido.</td>
    </tr>
    <tr>
        <td>sortable</td>
        <td>data-sortable</td>
    ...
    <tr>
        ...
        <td>undefined</td>
        <td>
        La funci贸n de formateo de la celda, toma tres par谩metros: <br>
	...
	<tr>
        ...
        La funci贸n toma un par谩metro: <br>
        data: Array de todas las filas. <br>
        La funci贸n debe retornar un string con el texto a mostrar en el footer.
    </tr>
    <tr>
        <td>events</td>
        <td>data-events</td>
        ...
        <td>undefined</td>
        <td>
        Los eventos de la celda son escuchados cuando se usa la funci贸n formatter, toma tres par谩metros: <br>
    ...
    <tr>
        ...
        <td>undefined</td>
        <td>
        La funci贸n sort es usada para hacer el ordenamiendo customizable, toma dos par谩metros: <br>
...
牋牋牋牋 de la columna. Por ejemplo, una columna puede mostrar el valor de nombreCampo de "HTML" como
牋牋牋牋 "<b><span style="color:red">abc</span></b>", pero una nombreCampo para ordenar es el "contenido" con el valor de "abc".
        </td>
    </tr>    
    <tr>
        <td>cellStyle</td>
        ...
        <td>undefined</td>
        <td>
        La funci贸n formatter para el estilo de la celda, toma tres par谩metros: <br>
        value: el valor del campo.<br>
        row: los datos de la fila.<br>
    ...
    <tr>
        ...
        <td>Boolean</td>
        <td>true</td>
        <td>True para incluir la columna en la b煤squeda.</td>
    </tr>
    </tbody>
</table>